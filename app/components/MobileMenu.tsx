      ...
      >
        ...
        >
          <div className="flex h-full flex-col">
            <div className="shrink-0 border-b border-slate-200 bg-white px-5 pb-5 pt-[max(2.5rem,env(safe-area-inset-top))]">
            ...
            <div className="shrink-0 border-t border-slate-200 bg-slate-50 px-5 pb-[max(1.5rem,env(safe-area-inset-bottom))] pt-5">
              <a
